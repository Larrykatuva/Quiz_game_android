...
public class Question11Fragment extends Fragment implements View.OnClickListener{
    ...
    public Question11Fragment(ArrayList<Question> questions, int saved){
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Question question = questions.get(10);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.btnB:
                getFragmentManager()
                        .beginTransaction()
                        .replace(R.id.questions_holder, new ElevenSave(questions,saved))
                        .commit();
                break;
            case R.id.btnA:
            case R.id.btnC:
