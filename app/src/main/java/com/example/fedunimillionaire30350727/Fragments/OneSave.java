...
public class OneSave extends Fragment implements View.OnClickListener{
    ...
    public OneSave(ArrayList<Question> questions, int saved){
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        amount.append("Do you want to save $"+1000);
    }
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.save:
                ...
                getFragmentManager()
                        .beginTransaction()
                        .replace(R.id.questions_holder, new Question2Fragment(questions,saved))
                        .commit();
                break;
            case R.id.skip:
                getFragmentManager()
